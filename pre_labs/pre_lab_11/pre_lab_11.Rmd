...
**Task** Run the following code and describe the dataframe it outputs. **Answer** This looks to be the data that is in the Maryland Board of Physicians website, showing things like doctor name and type of punishment.
...
This just produces one copy of each unique word.
```{r}
...
Produces a long list of each unique word from the data set.
```{r}
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer**This gives us a sideways bar graph that shows the top 25 most popular words in the data set. It is interesting, but could be better if we removed the stop words.
...
This shows the most common words used, but it removed the stop words for us this time. 
...
**Task** Run the following code and describe the results. **Answer** It's showing popular words from year to year, comparing 2022 and 2023, to see which words got more or less popular by year.
...
### Task 11: Create a dataframe with the top 10 two-word phrases for 2024

**Task** Run the following code and describe the results. **Answer** This is producing a list of the popular bigrams in the data for 2024.
...
**Task** Run the following code and describe the results. **Answer** This shows the popular bigrams for 2023, and which ones might be more/less popular from 2021.
...
**Task** Run the following code and describe the results. **Answer** This shows the top bigrams for 2022.
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer** The results show the sentiment connection to each of the words in the data. Potentially, "work" could be seen as negative instead of positive. An "appeal" in a court sense could be seen as negative if it's a bad decision.
