...
https://datawrapper.dwcdn.net/QoWXf/1/ 
...
The changes from the previous map is that it's way more zoomed in.
...
Now, we've changed the counties to be labeled, and the data is shown by county to see the percent of the amount of votes that went to Wes Moore.
...
https://datawrapper.dwcdn.net/lxDY8/1/ 
