...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **Answer** There is one column that goes in descending order by date.
...
**Task** Run the following code to extract the table we want, clean up the names and change the date column to an actual date. Look at the dataframe; what other information about these releases might you want to add? **Answer** We might want to add, if possible, a short description about each of the titles. Also, hyperlink text might be important.
...
tags there are in the HTML source? **Answer** 87.
...
tags. Describe the output: **Answer** The output is all 87 tag rows in the HTML data.
...
**Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer** Just a list put into a data table of the rows of what the HTML titles are.
