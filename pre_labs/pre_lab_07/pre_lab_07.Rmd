...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer** Howard County has the highest media household income.
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer** "Median household income by county in Maryland, calculated for error"
...
Is the difference between Calvert and Montgomery significant? **Answer** No, the bars overlap so there's not much of a difference.

Is the difference between Howard and everyone else significant? **Answer** Yes, decent outlier, bars don't overlap with any other county.
...
**Task** What is another question you could ask of this data? **Answer** I could ask whether these numbers of enrollments and percentages of graduates going to college by county change by year, but I'd need data for other years.